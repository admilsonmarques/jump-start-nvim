...
(local {: g : opt} (require :config.utils))
...
(local fillchars (.. "foldopen:" (core.get icons.ui :FolderOpen) ",foldclose:"
                     (core.get icons.ui :Folder) ",foldsep:"
                     (core.get icons.ui :LineDots) ",fold: "))
