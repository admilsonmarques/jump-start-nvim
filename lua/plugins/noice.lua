...
local lsp = {override = {["vim.lsp.util.convert_input_to_markdown_lines"] = true, ["vim.lsp.util.stylize_markdown"] = true, ["cmp.entry.get_documentation"] = true}, hover = {enabled = true}, signature = {enabled = true}}
...
local keys = {{"<leader>xn", "<CMD>Noice<CR>", mode = "n", desc = "Notifications"}}
local function _1_()
