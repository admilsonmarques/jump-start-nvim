...
local plugins = {spelling = {enabled = true, suggestions = 20}, presets = {nav = false, motions = false, operators = false, text_objects = false, g = false, z = false}, marks = false, registers = false}
