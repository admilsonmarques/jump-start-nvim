...
local spec = {{"<leader>q", "<CMD>bd<CR>", desc = "Quit buffer", mode = "n"}, {"<leader>a", group = "AI"}, {"<leader>aa", group = "AI Context"}, {"<leader>as", group = "AI Server"}, {"<leader>d", group = "Diagnostic"}, {"<leader>f", group = "Find"}, {"<leader>g", group = "Git"}, {"<leader>h", group = "Git Hunk"}, {"<leader>r", group = "Replace"}, {"<leader>T", group = "Themes"}, {"<leader>t", group = "Terminal"}, {"<leader>x", group = "Settings"}, {"<localleader>x", group = "Diagnostics"}}
local function _2_()
  vim.g["mapleader"] = " "
