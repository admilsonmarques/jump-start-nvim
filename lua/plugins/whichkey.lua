...
local plugins = {spelling = {enabled = true, suggestions = 20}, presets = {text_objects = true, z = true, g = false, operators = false, motions = false, nav = false}, registers = false, marks = false}
