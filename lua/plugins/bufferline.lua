...
local opts = {options = {mode = "buffers", numbers = "none", close_command = "", right_mouse_command = "vert sbuffer %d", left_mouse_command = "buffer %d", middle_mouse_command = nil, indicator = {icon = "\226\150\142", style = "icon"}, buffer_close_icon = "x", modified_icon = "\226\151\143", close_icon = "\239\128\141", left_trunc_marker = "\239\130\168", right_trunc_marker = "\239\130\169", truncate_names = true, diagnostics = "nvim_lsp", offset = offset, color_icons = true, show_buffer_icons = true, show_buffer_close_icons = true, persist_buffer_sort = true, separator_style = "thin", hover = {enable = true, delay = 100, reveal = {"close"}}, sort_by = "directory"}}
